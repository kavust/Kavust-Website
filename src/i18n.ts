...
const english: Record<string, string> = {
  ...
  'Yıllık Deneyim': 'Years of Experience', 'Ülke': 'Countries', 'Kurumsal Rol': 'Professional Roles',
  ...
  '"Şarap bir içki değil, bir hikaye anlatır."': '“Wine is not merely a drink; it tells a story.”', '"Şarap bir içki değil,': '“Wine is not merely a drink,', 'bir hikaye anlatır."': 'it tells a story.”', 'İletişime Geç': 'Get in Touch', 'Keşfet': 'Explore',
  ...
  ', konaklama ve gastronomi sektöründe uluslararası deneyime sahip bir sommelier ve servis profesyonelidir. Kariyerini Türkiye, Dubai ve Amerika Birleşik Devletleri’nde şekillendiren Kavüşt; şarap danışmanlığı, misafir deneyimi, ekip eğitimi ve restoran operasyonları alanlarında çalışmaktadır.': ', is a sommelier and service professional with international experience in hospitality and gastronomy. His career spans Türkiye, Dubai and the United States, with a focus on wine consulting, guest experience, team training and restaurant operations.',
