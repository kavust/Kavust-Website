...
export function translatePage(language: Language) {
  ...
  nodes.forEach((textNode) => {
    const original = textNode.nodeValue?.trim().replace(/\s+/g, ' ') ?? '';
